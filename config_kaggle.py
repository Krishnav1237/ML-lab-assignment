"""
Kaggle-specific configuration for Skin Disease Classifier

This configuration is designed to work with Kaggle's file system:
- Dataset: /kaggle/input/skin-disease-dataset/
...
if IS_KAGGLE:
    # Kaggle environment
    # IMPORTANT: Replace 'skin-disease-dataset' with your actual Kaggle dataset name
    BASE_DIR = '/kaggle/working'
    DATA_DIR = '/kaggle/input/skin-disease-dataset'  # UPDATE THIS with your dataset name
    MODEL_DIR = '/kaggle/working/models'
    LOG_DIR = '/kaggle/working/logs'
    OUTPUT_DIR = '/kaggle/working/outputs'
    GRADCAM_DIR = '/kaggle/working/outputs/gradcam'
else:
    # Local environment
...
KAGGLE_KERNEL_RUN = os.environ.get('KAGGLE_KERNEL_RUN_TYPE', '') != ''
KAGGLE_URL_BASE = "kaggle.com"

print(f"Configuration loaded for {'Kaggle' if IS_KAGGLE else 'Local'} environment")
if IS_KAGGLE:
